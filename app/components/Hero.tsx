...
function Hero() {
  ...
  return (
	...
	<div className="bg-[#294B29] text-white py-10 bg">
		<div className="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
			<div className="flex flex-col w-full lg:w-1/3 justify-center items-start p-8 ">
				<h3 className="text-1xl md:text-1xl p-2 text-yellow-300 tracking-loose">We create solutions using which</h3>
				<h2 className="text-3xl md:text-5xl leading-relaxed md:leading-snug mb-2">Anyone Can Grow!
				</h2>
